    ...
    <div className='about-section' id='about'>
        ...
        <div className="why-choose-us-text-container about-text">
            <div className="header" data-aos="fade-up">
                ...
                <h2>about starwoodcapital</h2>
            </div>
            <h1 data-aos="fade-up">learn more about starwood capital</h1>
            <p data-aos="fade-up">
                Starwood Capital Group is a private investment firm with a primary focus on global real estate. Since its inception in 1991, the Firm has raised over $75 billion of capital and currently has approximately $115 billion of assets under management. Over the past 32 years, Starwood Capital has invested in excess of $240 billion of assets, including properties within every major real estate asset class.
            </p>
        ...
        <div className="about-img-container" data-aos="fade-up">
            <img src="/pexels-alex-staudinger-1732414.jpg" alt="" data-aos="fade-up" className='about-img'/>
        </div>
        </div>
    </div>
  )
